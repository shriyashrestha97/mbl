...
<tr>
        ...
        <td><img src="postimages/<?php echo $row['PostImage']?>" width="200px;" height="200px;" alt="image"></td>
        
        <td><form action="code.php" method="post">
                  <input type="hidden" name="delete_client_ID" value="<?php echo $row['id']; ?>">
                  <button type="submit" name="client_delete_btn" class="btn btn-danger"> DELETE</button>
                </form> </td>
    </tr>
<?php
         }
