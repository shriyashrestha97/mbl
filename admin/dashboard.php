...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    ...
    enable_page_level_ads: true
        ...
        <!-- App title -->
        <title>MBL Fire Safety| Dashboard</title>
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="index.html" class="logo"><span>MBL<span>Admin</span></span><i class="mdi mdi-layers"></i></a>
                    <!-- Image logo -->
							...
							<div class="col-xs-12">
								<div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb p-0 m-0">
									 <li>
                                            <a href="https://www.projectnotes.org" target="_blank">MBL</a>
                                        </li>
                                        <li>
                                            <a  href="https://www.projectnotes.org" target="_blank">Fire Safety</a>
                                        </li>
                                        <li>
                                            <a  href="https://www.projectnotes.org" target="_blank">Admin</a>
                                        </li>
                                        <li class="active">
                                            Dashboard
                                        </li>
