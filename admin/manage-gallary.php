...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>MBL FIRE | Add Image</title>
...
<tr>
        ...
        <td><img src="postimages/<?php echo $row['PostImage']?>" width="100px;" height="100px;" alt="image"></td>
        
        <td><form action="code.php" method="post">
                  <input type="hidden" name="delete_post_ID" value="<?php echo $row['id']; ?>">
                  <button type="submit" name="post_delete_btn" class="btn btn-danger"> DELETE</button>
                </form> </td>
    </tr>
<?php
         }
