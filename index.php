...
<?php include("services.php")  ?>
 ...
 <!-- PHOTOGALLARY -->
  <center><section id="gallary" class="py-5" >
      <div class="container">
          <center><h1 class="text-center display-3">PHOTO GALLERY</h1></center>
...
if($check_gallary)
{
    ...
    {
        ?>
                <a href="#" class="item"><img src="admin/postimages/<?php echo($row['PostImage']);?>" class="img-thumbnail img-fluid" width="720px" height="960px">
